...
$(document).ready(function () {
  ...
  $("#ToDayDate").html("<div class='font13black' style='margin:0px auto 15px auto; color:#ff0000; font-weight:600;'>กิจกรรมประจำวันที่ "+thistoday_th);  
  Connect_DB();
...
function UserBoard(x) {
  ...
  dbttbGameRock.where('EmpID','==',sessionStorage.getItem("EmpID_Academy"))
